...
# $dlrm_pt_bin --arch-sparse-feature-size=16 --arch-mlp-bot="13-512-256-64-16" --arch-mlp-top="512-256-1" --data-generation=dataset --data-set=kaggle --raw-data-file=./input/train.txt --loss-function=bce --round-targets=True --learning-rate=0.1 --inference-only --load-model=model/model.pt --mini-batch-size=128 --print-freq=1024 --print-time --test-freq=1024 --memory-map $dlrm_extra_option 2>&1 | tee run_kaggle_pt.log
